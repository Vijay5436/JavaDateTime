...
public class JavaUtilDateExample
{
	public static void main(String args[])
	{
		...
		System.out.println("System date ; "+mydate.toString());//the current date print
		...
		int comparison1 = d2.compareTo(d1);
		int comparison2 = d1.compareTo(d1);
		System.out.println("d1 >d2 : "+ comparison);
		System.out.println("d1 < d2 : "+ comparison1);
		System.out.println("d1 = d1 : "+ comparison2);
		System.out.println("");
